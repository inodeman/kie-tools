...
export interface SWEditor extends GwtEditorWrapper, CanvasApi {
  mySWMethod(): string;
}

export class SWEditorImpl extends GwtEditorWrapper implements SWEditor {
  public mySWMethod() {
    return "sw-specific--configured";
  }
