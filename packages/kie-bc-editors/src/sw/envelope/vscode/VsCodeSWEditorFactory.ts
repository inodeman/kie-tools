...
import { SWEditorChannelApi } from "../../api";
...
import { VsCodeSWEditorChannelApi } from "./VsCodeSWEditorChannelApi";
...
class JavaCodeCompletionService implements JavaCodeCompletionApi {
  constructor(private readonly envelopeContext: KogitoEditorEnvelopeContextType<VsCodeSWEditorChannelApi>) {}
...
export class VsCodeSWEditorFactory implements EditorFactory<SWEditor, VsCodeSWEditorChannelApi> {
  constructor(private readonly gwtEditorEnvelopeConfig: { shouldLoadResourcesDynamically: boolean }) {}

  public createEditor(
    ctx: KogitoEditorEnvelopeContextType<VsCodeSWEditorChannelApi>,
    ...
    const factory = new SWEditorFactory(this.gwtEditorEnvelopeConfig);
