...
export interface ServerlessWorkflowEditor extends GwtEditorWrapper, CanvasApi {
  myServerlessWorkflowMethod(): string;
}

export class ServerlessWorkflowEditorImpl extends GwtEditorWrapper implements ServerlessWorkflowEditor {
  public myServerlessWorkflowMethod() {
    return "serverless-workflow-specific--configured";
  }
