...
import { ServerlessWorkflowEditorChannelApi, ServerlessWorkflowEditorEnvelopeApi } from "../api";
...
export type ServerlessWorkflowEnvelopeApiFactoryArgs = EnvelopeApiFactoryArgs<
  ServerlessWorkflowEditorEnvelopeApi,
  ServerlessWorkflowEditorChannelApi,
  EditorEnvelopeViewApi<ServerlessWorkflowEditor>,
  KogitoEditorEnvelopeContextType<ServerlessWorkflowEditorChannelApi>
>;

export class ServerlessWorkflowEditorEnvelopeApiImpl
  extends KogitoEditorEnvelopeApiImpl<
    ServerlessWorkflowEditor,
    ServerlessWorkflowEditorEnvelopeApi,
    ServerlessWorkflowEditorChannelApi
  >
  implements ServerlessWorkflowEditorEnvelopeApi
{
  constructor(
    private readonly serverlessWorkflowArgs: ServerlessWorkflowEnvelopeApiFactoryArgs,
    gwtEditorEnvelopeConfig: { shouldLoadResourcesDynamically: boolean }
  ) {
    super(serverlessWorkflowArgs, new ServerlessWorkflowEditorFactory(gwtEditorEnvelopeConfig));
  }

  public myServerlessWorkflowEnvelopeMethod() {
    this.serverlessWorkflowArgs.envelopeContext.channelApi.notifications.myServerlessWorkflowChannelMethod.send();
    const editor = this.view().getEditor();
    const ret = editor?.myServerlessWorkflowMethod() ?? "serverless-workflow-specific--default";
